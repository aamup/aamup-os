...
interface ModulePanelProps {
  activeModule: 'github' | 'weather' | 'markets' | 'news' | 'music' | 'briefing' | 'memory' | 'assistant'
  onSelect: (module: 'github' | 'weather' | 'markets' | 'news' | 'music' | 'briefing' | 'memory' | 'assistant') => void
}
  ...
  return (
    <section className="panel modules-panel">
      ...
      <div className="module-list">
        {modules.map((module) => {
          const selectableId =
            module.id === 'github' || module.id === 'weather' || module.id === 'markets' || module.id === 'news' || module.id === 'music' || module.id === 'briefing' || module.id === 'memory' || module.id === 'assistant'
              ? module.id
              : null
